...
public class HybridVehicleTest extends BaseTest {
    ...
    @Test(priority = 1, description = "Тест проверяет наличие справочника \"Тип гибридного транспортного средства\" в разделе справочников", testName = "Проверка наличия справочника \"Тип гибридного транспортного средства\" в разделе справочников")
    public void hybrid_test1() {
        page.goToDictionary();
        Assert.assertTrue(page.isDisplayedDictionary(), "Справочник не найден!");
    }

    @Test(priority = 2, description = "проверяет наличие записи \"Комбинированная энергоустановка последовательного типа\"")
    ...
    @Test(priority = 3, description = "проверяет наличие записи \"Комбинированная энергоустановка параллельного типа\"")
    ...
    @Test(priority = 4, description = "проверяет наличие атрибута \"Тип гибридного транспортного средства\" в дереве характеристик")
    ...
    @Test(priority = 5, description = "проверяет тип значения атрибута \"Тип гибридного транспортного средства\" в дереве характеристик")
    ...
    @Test(priority = 6, description = "проверяет длину поля атрибута \"Тип гибридного транспортного средства\" в дереве характеристик")
    ...
    @Test(priority = 7, description = "проверяет длину поля атрибута \"Описание гибридного транспортного средства\" в дереве характеристик")
    ...
    @Test(priority = 8, description = "проверяет наличие атрибута \"Тип гибридного транспортного средства\" в контейнере")
    ...
    @Test(priority = 9, description = "проверяет создание записи справочника \"Тип гибридного транспортного средства\"")
    ...
    @Test(priority = 10, description = "проверяет редактирование записи справочника \"Тип гибридного транспортного средства\"")
    ...
    @Test(priority = 11, description = "проверяет ошибку при привышении длины поля \"Наименование:\" в карточке записи справочника \"Тип гибридного транспортного средства\"")
    ...
    @Test(priority = 12, description = "проверяет удаление записи справочника \"Тип гибридного транспортного средства\"")
    ...
    @Test(priority = 13, description = "проверяет ошибку изменения статуса ОТТС, когда не активен атрибут \"Тип гибридного транспортного стредства\"")
